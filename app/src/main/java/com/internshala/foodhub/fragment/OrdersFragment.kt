...
import com.internshala.foodhub.adapter.OrderHistoryAdapter
import com.internshala.foodhub.model.OrderDetails
import com.internshala.foodhub.util.DrawerLocker
import com.internshala.foodhub.util.FETCH_PREVIOUS_ORDERS
                            ...
                            for (i in 0 until resArray.length()) {
                                ...
                                if (orderHistoryList.isEmpty()) {
                                    ...
                                    if (activity != null) {
                                        ...
                                        recyclerOrderHistory.layoutManager = mLayoutManager as RecyclerView.LayoutManager?
