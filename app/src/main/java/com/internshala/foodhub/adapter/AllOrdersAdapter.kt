...
class AllOrdersAdapter(
    ...
    RecyclerView.Adapter<AllOrdersAdapter.OrderHistoryViewHolder>() {
    ...
    override fun onBindViewHolder(p0: OrderHistoryViewHolder, p1: Int) {
        ...
        p0.txtUserName.text = orderHistoryObject.userName
    ...
    class OrderHistoryViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val txtUserName: TextView = view.findViewById(R.id.txtOrderUserName)
