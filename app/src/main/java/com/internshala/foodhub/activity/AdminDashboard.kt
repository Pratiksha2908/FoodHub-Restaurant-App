...
import com.internshala.foodhub.adapter.RestaurantMenuAdapter
import com.internshala.foodhub.fragment.*
import com.internshala.foodhub.util.DrawerLocker
import com.internshala.foodhub.util.SessionManager

class AdminDashboard : AppCompatActivity(), DrawerLocker {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sessionManager = SessionManager(this@AdminDashboard)
        sharedPrefs = this@AdminDashboard.getSharedPreferences(
        ...
        navigationView.setNavigationItemSelectedListener { item: MenuItem ->
            ...
            * We delay it by 0.1 second*/
            ...
            when (item.itemId) {
                ...
                /*Opening the All Orders fragment*/
                R.id.orders -> {
                    val orderHistoryFragment = OrdersFragment()
                ...
                R.id.logout -> {
                    ...
                    val builder = AlertDialog.Builder(this@AdminDashboard)
                    builder.setTitle("Confirmation")
                        .setMessage("Are you sure you want exit?")
                        .setPositiveButton("Yes") { _, _ ->
                            sessionManager.setLogin(false)
                            sharedPrefs.edit().clear().apply()
                            startActivity(Intent(this@AdminDashboard, OptionsActivity::class.java))
        ...
        * The method of using XML to add drawer layout is a better way*/
        val convertView = LayoutInflater.from(this@AdminDashboard).inflate(R.layout.drawer_header, null)
