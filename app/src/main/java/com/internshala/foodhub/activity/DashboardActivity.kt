...
import com.internshala.foodhub.fragment.RestaurantFragment.Companion.resId
        ...
        navigationView.setNavigationItemSelectedListener { item: MenuItem ->
            ...
            * We delay it by 0.1 second*/
            ...
            when (item.itemId) {
                ...
                /*Opening the restaurant fragment*/
                R.id.restaurantPage -> {
                ...
                R.id.logout -> {
                    ...
                    builder.setTitle("Confirmation")
                        ...
                        .setPositiveButton("Yes") { _, _ ->
                            ...
                            startActivity(Intent(this@DashboardActivity, OptionsActivity::class.java))
